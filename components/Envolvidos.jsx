  ...
  return (
    <div className="max-w-xl mx-auto p-4 relative overflow-hidden">
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={adicionar} className="ds-btn bg-pmrv text-white text-xs py-2 px-3 shadow-[3px_3px_0_#C8933F]">
          + Adicionar
        </button>
      </div>
          ...
          <div key={ev.id} className="ds-card">
            <div className="flex justify-between items-center border-b-2 border-charcoal pb-2">
              ...
              <button
                ...
                className="text-brick text-xs font-mono font-semibold uppercase border-2 border-brick px-2 py-1 hover:bg-[#F9ECE9] transition"
              >
                Remover
              </button>
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <button
                  ...
                  className="ds-btn bg-pmrv text-white text-[10px] font-mono font-semibold uppercase py-1 px-2 shadow-[2px_2px_0_#C8933F]"
                        ...
                        <div className="flex gap-1">
                          ...
                          {src && (
                            <button
                              ...
                              className="text-[10px] font-mono font-semibold uppercase border-2 border-brick text-brick px-2 py-1 bg-white hover:bg-[#F9ECE9] transition"
