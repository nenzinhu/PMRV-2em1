...
// `visao` é o modelo que lê imagens (aba Danos); provedor sem `visao` só entra
// na leitura de fotos se o usuário escolher um modelo reconhecido por modeloTemVisao.
