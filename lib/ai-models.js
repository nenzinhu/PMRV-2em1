...
// `visao` lista os modelos que leem imagens (aba Danos) — o primeiro é o padrão
// do provedor. Provedor sem `visao` só entra na leitura de fotos se o usuário
// escolher um modelo reconhecido por modeloTemVisao.
    ...
    visao: [
      {
        ...
        label: 'Llama 4 Scout',
        descricao: 'Muito rápido. Bom para uma leitura geral dos danos; pode omitir detalhes pequenos.',
      },
      {
        id: 'meta-llama/llama-4-maverick-17b-128e-instruct',
        label: 'Llama 4 Maverick',
        descricao: 'Mais detalhado que o Scout, ainda rápido. Melhor com várias fotos do mesmo veículo.',
      },
    ],
    modelos: {
    ...
    visao: [
      {
        ...
        label: 'Mistral Small',
        descricao: 'Recomendado. Equilíbrio entre velocidade e precisão; descreve bem peças e tipos de dano.',
      },
      {
        id: 'mistral-medium-latest',
        label: 'Mistral Medium',
        descricao: 'Mais preciso em danos sutis (trincas, desalinhamento) e em fotos com pouca luz. Um pouco mais lento.',
      },
      {
        id: 'mistral-large-latest',
        label: 'Mistral Large',
        descricao: 'O mais completo do Mistral: texto mais técnico e cuidadoso. Mais lento e consome mais cota.',
      },
    ],
    modelos: {
    ...
    visao: [
      {
        ...
        descricao: 'Gratuito e rápido. Alternativa quando Mistral e Groq estão sem cota.',
      },
    ],
...
const MODELO_VISAO =
  /vision|pixtral|[-_/.]vl\b|-vl-|llama-4|gemma-3|mistral-(small|medium|large)|magistral|glm-[\d.]+v\b|glm-[\d.]+v-|qwen3\.[5-9]|kimi-k2\.5|kimi-k3|gpt-4o|gpt-4\.1|gpt-5/i;
...
export const PMRV_MODELOS_VISAO = PMRV_PROVEDORES_IA.flatMap((p) =>
  (p.visao || []).map((m) => ({ ...m, provedor: p.id, provedorLabel: p.label }))
);
