...
const NAO_CHAT =
  /embed|rerank|whisper|tts|speech|transcri|moderation|guard|safeguard|ocr|clip|reward|retriev|detector|orpheus|playai|distil-whisper|image|audio|vision|flux|stable-diffusion/i;
...
export const PMRV_PROVEDORES_IA = [
  {
    ...
    // groq/compound-mini foi descontinuado em 21/09/2026.
    padrao: 'openai/gpt-oss-20b',
    modelos: {
      url: 'https://api.groq.com/openai/v1/models',
      filtro: (b) => idsDe((b?.data || []).filter((m) => m.active !== false)),
    },
    fallback: [
