...
export function buildAtendimentoPreHospitalar(form) {
  ...
  const lesao =
    form.lesaoNaoEspecificada || !(form.lesaoDescricao || '').trim()
      ...
      : `lesão: ${form.lesaoDescricao.trim()}`;
  ...
  return `O atendimento pré-hospitalar foi realizado pela viatura ${viaturaLabel}, constatando-se ${lesao}. Após o atendimento, ${vitima} foi ${destino}.`;
}
