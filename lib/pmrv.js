...
// Modelo gratuito do Gemini (via endpoint compatível com OpenAI). Outras opções
// gratuitas: 'gemini-2.5-flash', 'gemini-2.0-flash-lite', 'gemini-1.5-flash'.
export const PMRV_GEMINI_MODEL = 'gemini-2.0-flash';
