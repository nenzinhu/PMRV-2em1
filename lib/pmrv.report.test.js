...
describe('generateReport — fidelidade factual de data/hora', () => {
  ...
  it('imprime o nome da ponte no lugar de TIC01', () => {
    const texto = generateReport(formBase({ rodovia: 'TIC01' }));
    expect(texto).toContain('Rodovia: P. Hercílio Luz');
    expect(texto).not.toContain('TIC01');
  });
});
